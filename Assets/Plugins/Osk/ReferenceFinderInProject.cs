...
public class ReferenceFinderInProject : EditorWindow
{
	...
	[MenuItem("Assets/Find References In Project", false, 39)]
    static void FindObjectReferences()
    {
        //Show existing window instance. If one doesn't exist, make one.
        ReferenceFinderInProject window = EditorWindow.GetWindow<ReferenceFinderInProject>(true, "Find References In Project", true);
