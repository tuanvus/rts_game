...
public class ToolCreatorUnits : MonoBehaviour
{
    [SerializeField] private Object folderSavePrefab;
    [SerializeField] private Object folderSaveCs;


    [SerializeField] private GameObject prefabBaseUnit;
    [SerializeField] private List<GameObject> objUnitModel = new List<GameObject>();
    public string nameT;
    ...
    {
        foreach (var unitModel in objUnitModel)
        {
            var unit = Instantiate(prefabBaseUnit);
    ...
    {
        nameT = "";
        foreach (GameObject dataPrefab in objUnitModel)
        {
            if (dataPrefab != null)
            {
